...
<html lang="en">
    ...
    <body>
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">Salta3 Burger</h1>
                        <h2 class="home__subtitle">Try the best food of <br> Ka3 el hamour </h2>
                        <a href="#" class="button">View Menu</a>
                    </div>
    
                    <img src="assets/img/117988637_308815600569097_3023203393026894746_n.jpg" alt="" class="home__img">
                </div>
            </section>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial"Mat3amna atyab <br> mat3am </h2>
                        <p class="about__description">We cook the best food in the entire city, with excellent customer service, ma3 nafsyet 3ummel mtl l felle.</p>
                        <a href="#" class="button">Explore history</a>
                    </div>

                    <img src="assets/img/hqdefault.jpg" alt="" class="about__img">
                </div>
            </section>
            ...
            <section class="services section bd-container" id="services">
                ...
                <div class="services__container  bd-grid">
                    <div class="services__content">
                        ...
                        <h3 class="services__title">wasfe serrie</h3>
                        <p class="services__description">We offer our clients great service with al wasfa el serria.</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <h3 class="services__title">pizza bl samak teb5a salta3on</h3>
                        <p class="services__description">We offer our clients naw3yet akel mumteze tba5et l 3ayle kremelkon.</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <p class="services__description">We offer our clients excellent quality services mtl l delivery tb3 sandi.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="assets/img/117988637_308815600569097_3023203393026894746_n.jpg" alt="" class="menu__img">
                        <h3 class="menu__name">Mashewi salta3</h3>
                        <span class="menu__detail">shamshum mengehrin</span>
                        <span class="menu__preci">$22.00</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="assets/img/118402362_313215193462471_5605726520961635616_n.jpg" alt="" class="menu__img">
                        <h3 class="menu__name">3awez salta3 burger?</h3>
                        <span class="menu__detail">Shtri wahde bytl3lk tusile mn sandi bbalesh</span>
                        <span class="menu__preci">$24.00</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                    
                    <div class="menu__content">
                        <img src="assets/img/118819642_318917896225534_426761594329138269_n.jpg" alt="" class="menu__img">
                        <h3 class="menu__name">3ard salta3</h3>
                        <span class="menu__detail">shtri burger b dollar w khod tnen burger b dollaren</span>
                        <span class="menu__preci">$24.50</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                </div>
            </section>
        ...
        <footer class="footer section bd-container">
            <div class="footer__container bd-grid">
                <div class="footer__content">
                    <a href="#" class="footer__logo">Ka3 el hamur</a>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        <li><a href="#" class="footer__link">Salta3 Burger</a></li>
                        <li><a href="#" class="footer__link">mel3akat Spongebob</a></li>
     ...
     <a href="login.php">Click here</a> TO GET WASFET SALTA3 BURGER!
</html>